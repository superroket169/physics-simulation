...
namespace inert {
    ...
    namespace PureMath {
        ...
        inline float calculateAngularEffect(const PhysicsState& state, Vector3 r, Vector3 axis) {
        ...
        inline CollisionManifold checkSphereSphere(const PhysicsState& stateA, float radiusA, const PhysicsState& stateB, float radiusB, const PhysicsSettings& settings) {
        ...
        inline PositionalCorrectionResult calculatePositionalCorrection(const PhysicsState& stateA, const PhysicsState& stateB, const CollisionManifold& m, const PhysicsSettings& settings) {
        ...
        inline NormalImpulseResult calculateNormalImpulse(const PhysicsState& stateA, const PhysicsState& stateB, float restitutionA, float restitutionB, const CollisionManifold& m) {
        ...
        inline Vector3 calculateTangentImpulse(const PhysicsState& stateA, const PhysicsState& stateB, const CollisionManifold& m, float normalImpulseMag, const PhysicsSettings& settings) {
            Vector3 rA = Vector3Subtract(m.contactPoint, stateA.position);
            Vector3 rB = Vector3Subtract(m.contactPoint, stateB.position);
